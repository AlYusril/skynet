    ...
    <div class="page-header text-blue-d2">
        ...
        {{-- <div class="page-tools">
            <div class="action-buttons">
                ...
                <a class="btn bg-white btn-light mx-1px text-95" href="{{ url()->current() . '?output=pdf' }}" data-title="PDF">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <img src="{{ \Storage::url(settings()->get('app_logo')) }}" alt="logo" width="170"/>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span class="text-600 text-110 text-blue align-middle">{{ $tagihan->member->nama }}</span>
                        </div>
                        <div class="text-grey-m2">
                            <div class="my-1">
                                {{ $tagihan->member->alamat_lengkap }}
                            </div>
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">{{ $tagihan->member->nohp }}</b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <tbody class="text-95 text-secondary-d3">
                        ...
                        @foreach ($tagihan->tagihanDetails as $item)
                            <tr>
                                ...
                                <td class="text-95">{{ $item->created_at->translatedFormat('F') }}</td>
                                <td class="text-secondary-d2">{{ formatRupiah($item->jumlah_biaya) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    <span class="text-150 text-success-d3 opacity-2">{{ formatRupiah($tagihan->total_tagihan) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
