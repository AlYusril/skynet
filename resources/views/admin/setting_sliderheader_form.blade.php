    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-title">Input Slider</h6>

                <div class="form-group mt-3">
                    <label for="gambar">Gambar Slider | <span class="text-muted">Format : png,jpg,jpeg,svg. Ukuran Maksimal 2MB | Lebih baik file png tanpa background</span></label>
