...
class SettingSliderHeaderController extends Controller
{
    /**
    ...
    {
        $models = Model::where('jenis', 'slider')->get();
        return view('admin.setting_sliderheader_form',[
            'models' => $models,
        ]);
    }
